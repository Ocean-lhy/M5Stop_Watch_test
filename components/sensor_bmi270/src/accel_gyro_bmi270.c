...
static i2c_bus_device_handle_t i2c_dev_handle_bmi270;
static struct bmi2_dev bmi270;

esp_err_t accel_gyro_bmi270_init(i2c_bus_handle_t bus_handle)
{
    int8_t rslt;

    i2c_dev_handle_bmi270 = i2c_bus_device_create(bus_handle, I2C_DEV_ADDR_BMI270, 100000);
...
static int8_t bmi270_i2c_read(uint8_t reg_addr, uint8_t *reg_data, uint32_t len, void *intf_ptr)
{
    ...
    esp_err_t ret =
        i2c_bus_read_bytes(i2c_dev_handle_bmi270, reg_addr, len, reg_data);
...
static int8_t bmi270_i2c_write(uint8_t reg_addr, const uint8_t *reg_data, uint32_t len, void *intf_ptr)
{
    ...
    ret = i2c_bus_write_bytes(i2c_dev_handle_bmi270, reg_addr, len, reg_data);
    if (ret != ESP_OK) {
