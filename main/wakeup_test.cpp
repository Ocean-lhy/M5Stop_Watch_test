...
void wakeup_test(WakeupDevice wakeup_device, WakeupMode wakeup_mode)
{
    ...
    pm1_gpio_num_t wakeup_gpio_num = wakeup_device == WakeupDevice::PORT_WAKEUP ? PM1_GPIO_NUM_4 : PM1_GPIO_NUM_0;
    ...
    pm1_gpio_set_mode(PM1_GPIO_NUM_4, PM1_GPIO_MODE_INPUT);
    pm1_gpio_set_pupd(PM1_GPIO_NUM_4, PM1_GPIO_PUPD_PULLUP);
    ...
    if (wakeup_device == WakeupDevice::RTC_WAKEUP)
    {
        ...
        while (1)
        {
            ...
            pm1_gpio_get_in_state(PM1_GPIO_NUM_0, &gpio_state);
    ...
    else if (wakeup_device == WakeupDevice::IMU_WAKEUP)
    {
        ...
        while (1)
        {
            ...
            pm1_gpio_get_in_state(PM1_GPIO_NUM_0, &gpio_state);
            ESP_LOGI(TAG, "G0 state: %s", gpio_state == PM1_GPIO_IN_STATE_HIGH ? "HIGH" : "LOW");
            pm1_gpio_get_in_state(PM1_GPIO_NUM_4, &gpio_state);
